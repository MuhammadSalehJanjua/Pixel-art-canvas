...
export default function Footer() {
  return (
    <footer className="bg-[#2f3542] text-white py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-bold mb-4">Pixel Art Editor</h3>
            <p className="text-sm text-gray-300">
              Create beautiful pixel art with our easy-to-use editor. Perfect for game developers, artists, and
              hobbyists.
            </p>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-700 text-center text-sm text-gray-300">
          <p>&copy; {new Date().getFullYear()} Pixel Art Editor. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
